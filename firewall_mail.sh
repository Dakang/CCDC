...
iptables -A INPUT -p tcp --dport smtp -m state --state NEW,ESTABLISHED -j ACCEPT
iptables -A INPUT -p tcp --dport imap -m state --state NEW,ESTABLISHED -j ACCEPT
iptables -A INPUT -p tcp --dport pop3 -m state --state NEW,ESTABLISHED -j ACCEPT
...
iptables -A OUTPUT -p tcp --sport smtp -m state --state ESTABLISHED -j ACCEPT
iptables -A OUTPUT -p tcp --sport imap -m state --state ESTABLISHED -j ACCEPT
iptables -A OUTPUT -p tcp --sport pop3 -m state --state ESTABLISHED -j ACCEPT
